...
Public Class Form6
    ...
    Private Sub load_form()
        ...
        For i = 0 To cnt - 1
            Dim k As Integer
            For k = 0 To 4
                Dim data4 As New data4
                data4 = data_arr.Item(i)
